          ...
          <CardContent className="space-y-5 p-6">
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input
                  className="h-11 rounded-lg border-white/10 bg-black/30 pl-9 text-sm text-foreground placeholder:text-muted-foreground/70 focus-visible:ring-1 focus-visible:ring-primary/50 focus-visible:ring-offset-0"
                  id="email"
                  onChange={(event) =>
                    setForm((prev) => ({
                      ...prev,
