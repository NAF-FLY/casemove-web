...
// Validate ../../../src/app/api/storage/[id]/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/storage/[id]">> = Specific
  const handler = {} as typeof import("../../../src/app/api/storage/[id]/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
